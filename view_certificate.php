...
if(isset($_POST['search'])){
    ...
    while ($row = mysqli_fetch_array($query_run))
    {
     ...
     <p id="pp_cert">DATE..............................</p>               <p id="p_cert">District Manager</p> -->
         ...
         <br>
         <a href="view_certificate.php" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> Back</a>
         <script>
...
?>
<a href="user_homepage.php" style="font-size: 20px; float:right;"><i class="fa fa-arrow-left"></i> Return Home</a><br><br>
</center>
